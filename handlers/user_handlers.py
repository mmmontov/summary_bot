...
async def process_start_command(message: Message):
    await message.answer(text=LEXICON[message.text], reply_markup=ReplyKeyboardRemove())
...
# add to bookmarks (добавление в закладки)
...
# press on bookmark in boookmarks list
